...
router.get('/', async (req, res, next) => {
    try {
        ...
        next({err: err,
            stat: 500,
            message: 'Sorry, there was an error accessing list of resources.',
        });
    }
});
...
router.get('/:id', async (req, res, next) => {
    try {
        ...
        next({err: err,
            stat: 500,
            message: 'Sorry, there was an error accessing the resource.',
        });
    }
});
...
router.post('/', async (req, res, next) => {
    try {
        ...
        next({err: err,
            stat: 500,
            message: 'Sorry, there was an error accessing adding the resource.',
        });
    }
});
